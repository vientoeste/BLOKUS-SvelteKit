...
const roomCacheSchemaDef = {
  ...
  slot0_exhausted: { type: 'boolean' as const },
  slot1_exhausted: { type: 'boolean' as const },
  slot2_exhausted: { type: 'boolean' as const },
  slot3_exhausted: { type: 'boolean' as const },
...
const gameEndSchemaDef = {
  ...
  p3_confirm: { type: 'boolean' as const },
